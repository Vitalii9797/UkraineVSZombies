...
public class Zombie : MonoBehaviour
{
    ...
    [SerializeField] private float minWalkSpeed, maxWalkSpeed;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            canWalk = false;
            if (animator.enabled) animator.SetTrigger("fight");
    ...
    public void TakeDamage()
    {
        ...
        {
            gameManager.SplashBlood(transform.position);
    ...
    private void Death()
    {
        gameManager.GetRandomZombieSound().Play();  
    ...
    private float GetRandomWalkSpeed()
    {
        return Random.Range(minWalkSpeed, maxWalkSpeed);
    }
